...
// DeepCopy generates a deep copy of SELinuxPolicyStatusSpec.
func (o SELinuxPolicyStatusSpec) DeepCopy() SELinuxPolicyStatusSpec {
	var cp SELinuxPolicyStatusSpec = o
	if o.Modules != nil {
		cp.Modules = make([]string, len(o.Modules))
		copy(cp.Modules, o.Modules)
	}
	return cp
}
